"""tests/testgui/test_camera_combo.py — headless tests for the camera-selection
pull-down added to the main window (ticket 063-008).
...
Run with:
    QT_QPA_PLATFORM=offscreen uv run python -m pytest tests/testgui/test_camera_combo.py -q
"""
