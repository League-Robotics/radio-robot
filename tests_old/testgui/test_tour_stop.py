"""Tests for Tour/GOTO stop reactivation and Sim-mode tour gating (ticket 063-007).
...
Run with:
    QT_QPA_PLATFORM=offscreen uv run python -m pytest tests/testgui/test_tour_stop.py -v
"""
