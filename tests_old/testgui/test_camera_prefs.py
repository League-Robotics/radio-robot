"""tests/testgui/test_camera_prefs.py — headless, Qt-free tests for camera_prefs.
...
Run with:
    QT_QPA_PLATFORM=offscreen uv run python -m pytest tests/testgui/test_camera_prefs.py -q
"""
