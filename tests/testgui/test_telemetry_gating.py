"""tests/testgui/test_telemetry_gating.py -- ticket 085-007: live camera
...
Run with::
    ...
    QT_QPA_PLATFORM=offscreen uv run pytest tests/testgui/test_telemetry_gating.py -v
"""
...
def _make_on_truth_ready(state: dict, trace_model, canvas_ctrl):
    ...
    Mirrors the production code in
    ``host/robot_radio/testgui/__main__.py::_TelemetryBridge.on_truth_ready``:
