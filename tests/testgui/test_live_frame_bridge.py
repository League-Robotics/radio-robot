"""Tests for the live-view main-thread frame bridge (ticket 063-009).
...
Run with:
    QT_QPA_PLATFORM=offscreen uv run python -m pytest tests/testgui/test_live_frame_bridge.py -v
"""
...
# ---------------------------------------------------------------------------
#
# host/robot_radio/testgui/__main__.py's _on_connect()/_stop_live_worker()
...
# pattern in tests/testgui/test_set_origin.py and test_tour_stop.py, the
