"""tests/testgui/test_live_view.py — headless tests for the live-view worker.
...
Run with:
    QT_QPA_PLATFORM=offscreen uv run python -m pytest tests/testgui/test_live_view.py -q
"""
...
class TestDeskewBgrNdarray:
    ...
    def test_deskew_bgr_with_tag_frame_behavior_unchanged(self):
...
class TestLiveViewWorker:
    ...
    def test_module_importable_without_qt(self):
        ...
        import importlib
        import sys
        # We can't truly test without Qt since conftest already loaded it,
        # but we can verify the module exists and has build_live_view_worker.
