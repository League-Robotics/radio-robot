"""tests/testgui/test_live_view.py -- ticket 085-007: live camera view
...
Run with::
    ...
    QT_QPA_PLATFORM=offscreen uv run pytest tests/testgui/test_live_view.py -v
"""
...
class TestDeskewBgrNdarray:
    ...
    def test_deskew_bgr_with_tag_frame_behavior_unchanged(self, qapp):
        ...
        Running this file standalone (`pytest tests/testgui/test_live_view.py`,
