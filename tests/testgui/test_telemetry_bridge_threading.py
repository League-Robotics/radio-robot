"""tests/testgui/test_telemetry_bridge_threading.py -- emergency fix
...
Run with:
    QT_QPA_PLATFORM=offscreen uv run pytest tests/testgui/test_telemetry_bridge_threading.py -v
"""
