"""tests/testgui/test_sim_errors_from_cal_button.py -- ticket 085-006: the
...
Run with::
    ...
    QT_QPA_PLATFORM=offscreen uv run pytest tests/testgui/test_sim_errors_from_cal_button.py -v
"""
