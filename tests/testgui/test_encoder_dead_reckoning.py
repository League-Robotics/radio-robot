"""tests/testgui/test_encoder_dead_reckoning.py — 097 (this ticket, Goal 3):
...
Run with::
    ...
    QT_QPA_PLATFORM=offscreen uv run pytest tests/testgui/test_encoder_dead_reckoning.py -q
"""
