"""tests/unit/test_clock_sync.py -- 099-009 (SUC-005).
...
playfield script (``tests/playfield/pose_fix_convergence.py``) uses for its
...
``host/robot_radio/robot/`` tree verbatim during the sprint 077 greenfield
