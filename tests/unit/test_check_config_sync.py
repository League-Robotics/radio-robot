"""tests/unit/test_check_config_sync.py — 096-008 (check_config_sync.py rewrite).
...
Collected under tests/unit/ (a host-tooling check, not sim/bench/playfield-
...
# tests/unit/test_check_config_sync.py -> unit -> tests -> repo root
_REPO_ROOT = Path(__file__).resolve().parents[2]
_SCRIPT = _REPO_ROOT / "scripts" / "check_config_sync.py"
