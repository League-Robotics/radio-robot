...
scenario with:
    ...
    uv run python -m pytest tests/sim/system/test_scripted_twist_demo.py -v
...
(equivalent to ``pytest tests/sim/system/test_scripted_twist_demo.py -v -s``
...
# tests/sim/system/test_scripted_twist_demo.py -> system -> sim -> tests -> repo root
