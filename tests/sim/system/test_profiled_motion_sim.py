"""tests/sim/system/test_profiled_motion_sim.py -- 106-006 (SUC-030) Phase 1:
...
``testpaths = ["tests/sim"]``, no configuration change needed:
    ...
    uv run python -m pytest tests/sim/system/test_profiled_motion_sim.py -v -s
"""
...
# tests/sim/system/test_profiled_motion_sim.py -> system -> sim -> tests -> repo root
