// jerk_trajectory_harness.cpp -- off-hardware acceptance harness for
// ticket 089-002 (SUC-002/SUC-003/SUC-004/SUC-005): exercises
// Motion::JerkTrajectory (source/motion/jerk_trajectory.{h,cpp}) in
// isolation, mirroring ruckig_smoke_harness.cpp's/velocity_pid_harness.cpp's
// compile-and-run pattern -- hand-rolled assertions, no gtest/pytest-native
// C++ framework, run via test_jerk_trajectory.py.
//
// Scenarios map directly onto the ticket's testing plan (a)-(h):
