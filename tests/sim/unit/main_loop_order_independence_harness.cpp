...
// with the real source/subsystems/{drivetrain,sim_hardware,pose_estimator,
...
// source/hal/sim/*.cpp, and source/hal/velocity_pid.cpp -- deliberately NOT
// linking source/runtime/main_loop.cpp itself (this harness drives the four
