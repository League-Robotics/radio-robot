"""tests/bench/rig_drive.py -- HITL turn test: run the REAL source/drive turn
...
in) always terminate. Run:  uv run python tests/bench/rig_drive.py [deg]
"""
...
sys.path.insert(0, str(_REPO / "tests" / "_infra" / "drive"))
sys.path.insert(0, str(_REPO / "tests" / "bench"))
