...
//   CommandEnvelope: drive=56B, segment=83B, replace=83B, config=109B, pose_fix=27B, otos=19B, ping=2B, echo=68B, get=4B, stream=10B, stop=2B, id=162B, hello=2B, ver=3B, help=3B, plan_dump=3B (worst=id=162B) + non-oneof=6B => total=168B
