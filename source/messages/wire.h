...
//   CommandEnvelope: drive=56B, segment=64B, replace=64B, config=36B, pose_fix=27B, otos=19B, ping=2B, echo=68B, get=4B, stream=10B, stop=2B, id=162B, hello=2B, ver=3B, help=3B (worst=id=162B) + non-oneof=6B => total=168B
//   ReplyEnvelope: ok=19B, err=10B, tlm=165B, cfg=38B, evt=2B, id=162B, echo=68B, helptext=67B (worst=tlm=165B) + non-oneof=6B => total=171B
