...
// Source: /Volumes/Proj/proj/RobotProjects/radio-robot-elite/data/robots/tovez_nocal.json
...
RobotConfig defaultRobotConfig() {
    ...
    p.wheelTravelCalibL = 0.7048512f;
    p.wheelTravelCalibR = 0.7048512f;
