...
Transports:
  uv run python src/tests/bench/gamepad_teleop.py --port /dev/cu.usbmodemXXX             # direct USB
  uv run python src/tests/bench/gamepad_teleop.py --port /dev/cu.usbmodemYYY --relay     # radio relay
