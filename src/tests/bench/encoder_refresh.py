...
Usage:
    ...
    uv run python src/tests/bench/encoder_refresh.py \\
        --analyze src/tests/bench/out/encoder_refresh.csv

Outputs, both under `src/tests/bench/out/`:
...
_REPO_ROOT = pathlib.Path(__file__).resolve().parents[3]  # 128-010: src/tests/bench/
...
def report(rows: "list[dict]") -> str:
    ...
    out = ["# Encoder refresh interval -- bench measurement",
           "",
           "Generated by `src/tests/bench/encoder_refresh.py`",
