...
(`src/host/robot_radio/robot/protocol.py`). Runs unchanged against a direct-USB
...
Usage:
    uv run python src/tests/bench/dev_exercise.py
    uv run python src/tests/bench/dev_exercise.py --port /dev/cu.usbmodem2121102 --motor 1
"""
