...
def main() -> int:
    ...
    import csv
    with open("src/tests/bench/output/speed_sweep.csv", "w", newline="") as f:
        w = csv.writer(f)
    ...
    fig.tight_layout()
    fig.savefig("src/tests/bench/output/speed_sweep.png", dpi=130)
    print("wrote src/tests/bench/output/speed_sweep.{csv,png}")
    return 0
