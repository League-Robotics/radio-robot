...
CSV_FIELDNAMES: "tuple[str, ...]" = (
    ...
    "flag_conn_left", "flag_conn_right",
...
def frame_to_row(frame: TLMFrame) -> "dict[str, object]":
    ...
    return {
        ...
        "acks": [(e.corr_id, e.err_code) for e in frame.acks],
        ...
        "enc_left_age": enc_left.age if enc_left is not None else None,
        "enc_left_position_epoch": enc_left.position_epoch if enc_left is not None else None,
        ...
        "enc_right_age": enc_right.age if enc_right is not None else None,
        "enc_right_position_epoch": enc_right.position_epoch if enc_right is not None else None,
        ...
        "otos_age": otos.age if otos is not None else None,
        "pose_x": pose_x,
        "pose_y": pose_y,
