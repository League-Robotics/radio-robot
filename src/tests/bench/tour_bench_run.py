#!/usr/bin/env python3
"""src/tests/bench/tour_bench_run.py -- 107-005 (SUC-036): run TOUR_1/TOUR_2 for
...
`src/tests/bench/out/`, mirroring that script's own `profiled_<leg>_<timestamp>`
...
Usage:
    uv run python src/tests/bench/tour_bench_run.py
    uv run python src/tests/bench/tour_bench_run.py --port /dev/cu.usbmodem2121102
    uv run python src/tests/bench/tour_bench_run.py --tours TOUR_1 --runs 3
    uv run python src/tests/bench/tour_bench_run.py --runs 3 \\
