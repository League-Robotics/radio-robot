...
`src/tests/bench/tour_bench_run.py` produced during the 107-005 bench session
...
The script's own primary output location is `src/tests/bench/out/` (gitignored,
...
trace data from a **fresh checkout**, where `src/tests/bench/out/` will not
