"""src/tests/testgui/test_sim_errors_from_calibration.py -- ticket 085-006: "From
...
Run with::
    ...
    QT_QPA_PLATFORM=offscreen uv run pytest src/tests/testgui/test_sim_errors_from_calibration.py -v
"""
