"""src/tests/testgui/test_mode_indicator.py -- ticket 085-008: mode label test
...
Run with::
    ...
    QT_QPA_PLATFORM=offscreen uv run pytest src/tests/testgui/test_mode_indicator.py -v
"""
