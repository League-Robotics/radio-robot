"""src/tests/testgui/test_set_origin.py -- ticket 085-004: Operations panel
...
Run with::
    ...
    QT_QPA_PLATFORM=offscreen uv run pytest src/tests/testgui/test_set_origin.py -v
"""
...
@_requires_sim_lib
@pytest.mark.xfail(
    reason="097: OZ/SI (SetPose) have no binary arm until sprint 098 -- "
           "the origin_btn's OZ/SI wire commands are gated no-ops (and the "
