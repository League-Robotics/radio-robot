"""src/tests/testgui/test_drive.py — headless tests for KeyboardDriver (ticket 083-002).
...
Run with::
    ...
    QT_QPA_PLATFORM=offscreen uv run pytest src/tests/testgui/test_drive.py -q
