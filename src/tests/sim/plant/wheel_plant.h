...
// integration, via Kinematics::Differential::forward() over two WheelPlant
...
// reportedPosition() (e.g. src/tests/sim/system/test_scripted_twist_demo.py,
...
// integrating it -- see src/tests/testgui/test_sim_loop.py's
