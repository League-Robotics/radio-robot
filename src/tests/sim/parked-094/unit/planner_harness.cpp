...
// of src/firm/ to source_parked/094/subsystems/ (see that file's own header
// note + src/tests/sim/parked-094/README.md). Must return alongside Planner
...
// (src/firm/subsystems/planner.{h,cpp}) in isolation against hand-built
...
// command gained the extra src/firm/include entries this pulls in). The
