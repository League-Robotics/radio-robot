...
msg::PlannerConfig defaultPlannerConfig() {
    ...
    cfg.setYawRateMax(3.999946f);         // [rad/s] (control.yaw_rate_max [deg/s])
    cfg.setYawAccMax(20.00008f);          // [rad/s^2] (control.max_rot_accel_dps2 [deg/s^2])
    cfg.setJMax(5000.0f);                // [mm/s^3] ~6x a_max -- ~0.16s jerk-limited edges
    cfg.setYawJerkMax(100.0f);         // [rad/s^3] ~5x yaw_acc_max -- ~0.2s
    cfg.setHeadingKp(2.5f);              // [1/s] outer heading-loop proportional gain
    ...
    cfg.setDistanceKp(2.5f);              // [1/s]
    cfg.setDistanceTol(6.0f);             // [mm]
