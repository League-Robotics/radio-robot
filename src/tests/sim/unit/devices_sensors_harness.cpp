...
//
// Modeled on src/tests/sim/unit/devices_otos_harness.cpp (that file's own header
// comment is this harness's explicit test precedent) -- compiles the ACTUAL
// src/firm/devices/{color_sensor,line_sensor}.cpp against the SAME
// src/firm/devices/{color_sensor,line_sensor}.h every ARM build compiles, with
