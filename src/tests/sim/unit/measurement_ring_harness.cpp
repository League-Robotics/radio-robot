...
// contract (src/firm/devices/measurement_ring.h), plus the linear and
// wrap-aware angular lerp helpers (src/firm/devices/interpolation.h).
//
...
// consistency with every other src/tests/sim/unit harness, though neither
