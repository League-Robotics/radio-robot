...
# src/firm/motion/ (planner/navigator/odometry/estimation) no longer
# exists -- Control::DifferentialDrive folded the wheel control it fed
# into one class + fiber. Nothing in this harness's own dependency graph
# needs it any more.
_MOTION_SOURCES = []
_CONFIG_SOURCES = [
