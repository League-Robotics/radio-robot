...
Usage:
    uv run python src/tests/bench/velocity_chart.py [--port DEV] [--speed MMPS]
        [--window S] [--max-speed MMPS] [--left-port N] [--right-port N]
        [--poll-period S]

    # No GUI: run the worker for SECS seconds, print a text summary.
    uv run python src/tests/bench/velocity_chart.py --headless 5
    ...
    uv run python src/tests/bench/velocity_chart.py --selftest
"""
