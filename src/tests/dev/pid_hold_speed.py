...
Usage:
    uv run python src/tests/bench/pid_hold_speed.py
    uv run python src/tests/bench/pid_hold_speed.py --pid-port 3 --load-port 4 --target 150
    uv run python src/tests/bench/pid_hold_speed.py --load-duties 50,25,0,-25,-50
"""
...
def _parse_args() -> argparse.Namespace:
    ...
    p.add_argument("--csv", default=str(_REPO_ROOT / "src" / "tests" / "bench" / "out" / "pid_hold_speed.csv"),
...
# are standalone CLI tools per the ticket's locked src/tests/bench/ layout, not a
