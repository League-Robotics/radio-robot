// differential_drive.cpp — Control::DifferentialDrive implementation.
// See differential_drive.h's file header for the contract, and the
// exploratory-kernel issue's hard-lessons ledger for the semantics every
// stage below preserves (stop is stop; never flip direction; fail closed;
// stop-enforce; λ-scaled anti-windup; measured dt only).
...
void DifferentialDrive::refreshSample(Hal::Motor& motor, WheelSample& sample) {
