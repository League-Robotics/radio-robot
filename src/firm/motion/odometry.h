...
// Kinematics::Differential::forward(), accumulating x/y/theta. Outside -- reading the
...
class Odometry {
 public:
  // trackWidth -- [mm], Kinematics::Differential::forward()'s own `b` parameter.
  ...
  // maps the delta pair through Kinematics::Differential::forward() (NOT a
