...
constexpr MessageTable kMessageTables[] = {
    ...
    kTable_Error,  // 6
    kTable_Telemetry,  // 7
    kTable_DrivetrainConfigPatch,  // 8
    kTable_MotorConfigPatch,  // 9
    kTable_OtosConfigPatch,  // 10
    kTable_EstimatorConfigPatch,  // 11
    kTable_MoveTwist,  // 12
