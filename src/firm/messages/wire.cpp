...
constexpr MessageTable kTable_Telemetry = { kFields_Telemetry, 16 };
...
constexpr MessageTable kMessageTables[] = {
    ...
    kTable_EstimatorConfigPatch,  // 12
    kTable_MoveTwist,  // 13
