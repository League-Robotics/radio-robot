...
constexpr FieldDesc kFields_EstimatorConfigPatch[] = {
    ...
    { .number = 4, .wireType = WireRuntime::WireType::kFixed32, .kind = FieldKind::kOpt, .scalarType = ScalarType::kFloat, .offset = offsetof(EstimatorConfigPatch, stop_lead_ms.has), .offset2 = offsetof(EstimatorConfigPatch, stop_lead_ms.val), .oneofKindValue = 0, .cap = 0, .tableIndex = 0xFF, .elemStride = 0, .flags = 0, .minVal = 0.0f, .maxVal = 0.0f, .absMaxVal = 0.0f },  // stop_lead_ms
...
constexpr MessageTable kTable_EstimatorConfigPatch = { kFields_EstimatorConfigPatch, 10 };
