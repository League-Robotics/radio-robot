...
constexpr FieldDesc kFields_TelemetrySecondary[] = {
    ...
    { .number = 11, .wireType = WireRuntime::WireType::kVarint, .kind = FieldKind::kScalar, .scalarType = ScalarType::kUint32, .offset = offsetof(TelemetrySecondary, cycle_busy), .offset2 = 0, .oneofKindValue = 0, .cap = 0, .tableIndex = 0xFF, .elemStride = 0, .flags = kHasMax, .minVal = 0.0f, .maxVal = 200000.0f, .absMaxVal = 0.0f },  // cycle_busy
    { .number = 12, .wireType = WireRuntime::WireType::kVarint, .kind = FieldKind::kScalar, .scalarType = ScalarType::kUint32, .offset = offsetof(TelemetrySecondary, cycle_period), .offset2 = 0, .oneofKindValue = 0, .cap = 0, .tableIndex = 0xFF, .elemStride = 0, .flags = kHasMax, .minVal = 0.0f, .maxVal = 200000.0f, .absMaxVal = 0.0f },  // cycle_period
};
constexpr MessageTable kTable_TelemetrySecondary = { kFields_TelemetrySecondary, 12 };
