...
static_assert(std::is_standard_layout<Wheels>::value,
...
static_assert(std::is_standard_layout<Calibrate>::value,
              "msg::Calibrate must be standard-layout for offsetof-based field tables");
